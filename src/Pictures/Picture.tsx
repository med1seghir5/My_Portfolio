...
const cards = [
  ...
  "/src/assets/gdg.JPG",
  "/src/assets/ice.jpeg",
  "/src/assets/devfestteam.jpg",
  "/src/assets/icebreak.jpeg",
];
...
export default function Deck() {
  ...
  return (
    <div id="Memories" className="flex flex-col justify-center items-center overflow-hidden pb-40 mt-32 md:pb-56 md:mt-48">
      ...
      <div className="w-full flex justify-center items-center relative mt-52 md:mt-72">
        {props.map(({ x, y, rot, scale }, i) => (
          <animated.div
            className={`${styles.deck} absolute`}
            key={i}
            style={{ x, y }}
          >
            <animated.div
